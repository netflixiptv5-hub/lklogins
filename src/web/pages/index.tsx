...
type JobStatus = "idle" | "connecting" | "logged_in" | "searching" | "found" | "not_found" | "error" | "expired_waiting";
              ...
              {jobStatus === "idle" ? (
                ...
                <>
                  ...
                  <div className="text-center">
                    ...
                    {jobStatus === "not_found" && (
                      <div className="mb-4">
                        ...
                        <div className="bg-[#161616] rounded p-4 text-left mb-4 border border-[#333]">
                          <p className="text-[#F5A623] text-sm font-semibold mb-2">O que fazer:</p>
                          <ul className="text-[#B3B3B3] text-sm space-y-2">
                            <li>• Reenvie a solicitação no serviço</li>
                            <li>• Aguarde 1-2 minutos para o email chegar</li>
                            <li>• Volte aqui e tente novamente</li>
                          </ul>
                        </div>
                        <div className="bg-[#1a1212] rounded p-4 text-left mb-4 border border-[#E50914]/20">
                          <p className="text-[#E50914] text-sm font-semibold mb-2">⚠️ Você selecionou a opção correta?</p>
                          <p className="text-[#999] text-xs leading-relaxed">
                            Confira se a opção escolhida corresponde ao que você solicitou.
                            {" "}Por exemplo: se você pediu um <strong className="text-white">código temporário</strong>,
                            {" "}selecione <strong className="text-white">"Código Temporário"</strong> e não "Residência" ou "Redefinição de Senha".
                            {" "}Cada opção busca um tipo diferente de email.
                          </p>
                    ...
                    {/* Back button */}
                    {(jobStatus === "found" || jobStatus === "not_found" || jobStatus === "error") && jobStatus !== "expired_waiting" && (
                      <button
                        onClick={reset}

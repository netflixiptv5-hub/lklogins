...
const SERVICE_OPTIONS = [
  ...
  },
  {
    id: "hbo_reset",
    title: "Senha HBO Max",
    description: "Link de redefinição de senha HBO Max",
    icon: "🟣",
    brand: "hbo",
    confirmTitle: "Atenção!",
    confirmMessage: "Você já solicitou a redefinição de senha no HBO Max?",
    confirmDetail: "Se ainda não solicitou, acesse o link abaixo e solicite antes de continuar:",
    confirmLink: "https://auth.hbomax.com/forgot-password",
    confirmLinkText: "Solicitar Redefinição no HBO Max →",
    confirmButton: "JÁ SOLICITEI, CONTINUAR",
  },
  {
    id: "globo_reset",
                  ...
                  <div className="text-center">
                    ...
                    {jobStatus === "error" && errorMessage?.includes("PHONE_ONLY") && (
                      <div className="mb-4">
                        ...
                        <div className="bg-[#2D1B4E] rounded-lg p-5 text-center mb-4 border border-[#7C3AED]/40">
                          <p className="text-white text-sm font-semibold mb-3">⚠️ Esta conta só tem verificação por telefone!</p>
                          <p className="text-[#C4B5FD] text-sm mb-5">
                            Não é possível acessar esta conta automaticamente.
                          </p>
                          <div className="bg-[#1a1130] rounded-lg p-4 border border-[#7C3AED]/30">
                            <p className="text-[#A855F7] text-lg font-bold">Contate seu ADM</p>
                          </div>
                        </div>
                      </div>
                    )}
